...
public class StatController {
    ...
    public Map<String ,Integer> passingRate(String userId, Integer range, Integer year){
        try {
            map.clear();
            //开始时间，用于最终sql查询参数
    ...
    public Map<String ,Integer> halfYearAndState(Integer range, Integer year){
        try {
            map.clear();
            //开始时间，用于最终sql查询参数
            LocalDateTime startDateTime;
    ...
    public Map<String ,Integer> halfYearAndType(Integer range, Integer year){
        try {
            map.clear();
            //开始时间，用于最终sql查询参数
            LocalDateTime startDateTime;
    ...
    public Map<String ,Integer> halfYearAndSchool(Integer range, Integer year){
        try {
            map.clear();
            //开始时间，用于最终sql查询参数
            LocalDateTime startDateTime;
